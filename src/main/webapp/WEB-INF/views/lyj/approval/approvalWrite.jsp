		            ...
		            <form id="insertForm" action="insert.ep" method="post">
		            	...
		            	<table id="formLine" class="table" align="center">
			                ...
			                <tbody>
			                	<tr>
			                		<th>이름</th>
			                		<td><input type="text" id="mName" class="form-control" name="approvalMName" readonly required></td>
			                		<td><input type="text" id="fName" class="form-control" name="approvalFName" readonly required></td>
			                	</tr>
			                	<tr>
			                		<th>부서</th>
			                		<td><input type="text" id="mDept" class="form-control" name="approvalMDept" readonly required></td>
			                		<td><input type="text" id="fDept" class="form-control" name="approvalFDept" readonly required></td>
			                	</tr>
			                	<tr>
			                		<th>직급</th>
			                		<td><input type="text" id="mJob" class="form-control" name="approvalMJob" readonly required></td>
